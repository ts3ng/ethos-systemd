...
etcd-set /images/dd-agent     			"index.docker.io/behance/docker-dd-agent"
...
etcd-set /images/jenkins				"index.docker.io/jenkins"
etcd-set /images/dd-agent-mesos 		"index.docker.io/behance/docker-dd-agent-mesos"
