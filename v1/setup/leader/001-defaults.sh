...
etcd-set /images/flight-director        "index.docker.io/behance/flight-director:c9a65ab6990f3c29d164a4588d872714d4361f6e"
...
etcd-set /images/zk-exhibitor           "index.docker.io/behance/docker-zk-exhibitor:ns1.5"
