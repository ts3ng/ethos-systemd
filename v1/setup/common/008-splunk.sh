...
LABEL_TYPE="logging-type"
LABEL_INDEX="logging-index"
LABEL_SOURCETYPE="logging-sourcetype"
LABEL_VOLUME="logging-volume"
SPLUNK_HEAVYFORWARDER_ENDPOINT="https://localhost:8089"
...
#set some etcd values
etcd-set /splunk/config/label-index $LABEL_INDEX
etcd-set /splunk/config/label-type $LABEL_TYPE
etcd-set /splunk/config/label-sourcetype $LABEL_SOURCETYPE
etcd-set /splunk/config/label-volume $LABEL_VOLUME
etcd-set /splunk/config/heavyforwarder-endpoint $SPLUNK_HEAVYFORWARDER_ENDPOINT
